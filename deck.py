...
Document Assistance (who and what or declare no assistance): I recived help from Professor Mueller on the function move to deal card.
...
class Deck:
    ...
    def moveToDealNext(self, cardToMove):
        ...
        returns False
        '''
        index_moveCard = self.cardList.index(cardToMove)
        if self.currentIndex > index_moveCard:
            return False
        else:
